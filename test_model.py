...
def main():
    video_path = Path("C:\\cricket-ai\\data\\samples\\videoplayback.mp4").resolve()
    ...
    model_path = "C:\\cricket-ai\\train2\\weights\\best.pt"  # small, fast model. Replace with your fine-tuned weights later.
